...
import com.alpine.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
     ...
     * {@link com.alpine.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.alpine.app.AlpineActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
