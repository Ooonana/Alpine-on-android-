...
public class AlpineOpenReceiver extends BroadcastReceiver {

    private static final String LOG_TAG = "AlpineOpenReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Uri uriToShare = UriUtils.getContentUri(AlpineConstants.ALPINE_FILE_SHARE_URI_AUTHORITY, fileToShare.getAbsolutePath());
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        private static final String LOG_TAG = "AlpineContentProvider";
