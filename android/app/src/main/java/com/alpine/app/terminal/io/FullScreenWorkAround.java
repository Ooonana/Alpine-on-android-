...
/**
 * Work around for fullscreen mode in Alpine to fix ExtraKeysView not being visible.
...
public class FullScreenWorkAround {
    ...
    public static void apply(AlpineActivity activity) {
        new FullScreenWorkAround(activity);
    }

    private FullScreenWorkAround(AlpineActivity activity) {
