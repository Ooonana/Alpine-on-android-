package com.alpine.app.fragments.settings.alpine_tasker;
...
public class DebuggingPreferencesFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferencesFromResource(R.xml.alpine_tasker_debugging_preferences, rootKey);
    ...
    private void configureLoggingPreferences(@NonNull Context context) {
        ...
        if (logLevelListPreference != null) {
            AlpineTaskerAppSharedPreferences preferences = AlpineTaskerAppSharedPreferences.build(context, true);
            if (preferences == null) return;

            com.alpine.app.fragments.settings.alpine.DebuggingPreferencesFragment.
