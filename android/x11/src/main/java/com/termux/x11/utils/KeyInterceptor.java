...
public class KeyInterceptor extends AccessibilityService {
    ...
    public static void launch(@NonNull Context ctx) {
        try {
            Settings.Secure.putString(ctx.getContentResolver(), Settings.Secure.ENABLED_ACCESSIBILITY_SERVICES, BuildConfig.APPLICATION_ID + "/com.termux.x11.utils.KeyInterceptor");
