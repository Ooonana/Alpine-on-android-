...
public class X11ToolbarViewPager {
    public static class PageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup collection, int position) {
            ...
            View layout;
            if (position == 0) {
                layout = inflater.inflate(R.layout.x11_view_terminal_toolbar_extra_keys, collection, false);
                ...
                layout = inflater.inflate(R.layout.x11_view_terminal_toolbar_text_input, collection, false);
