...
import com.alpine.shared.reflection.ReflectionUtils;
...
import com.alpine.shared.alpine.AlpineConstants.ALPINE_APP;
...
public class AlpineUtils {
    ...
    public enum AppInfoMode {
        /** Get info for Alpine app only. */
        ALPINE_PACKAGE,
        /** Get info for Alpine app and plugin app if context is of plugin app. */
        ALPINE_AND_PLUGIN_PACKAGE,
        /** Get info for Alpine app and its plugins listed in {@link AlpineConstants#ALPINE_PLUGIN_APP_PACKAGE_NAMES_LIST}. */
        ALPINE_AND_PLUGIN_PACKAGES,
        /* Get info for all the Alpine app plugins listed in {@link AlpineConstants#ALPINE_PLUGIN_APP_PACKAGE_NAMES_LIST}. */
        ALPINE_PLUGIN_PACKAGES,
        /* Get info for Alpine app and the calling package that called a Alpine API. */
        ALPINE_AND_CALLING_PACKAGE,
    }

    private static final String LOG_TAG = "AlpineUtils";

    /**
     * Get the {@link Context} for {@link AlpineConstants#ALPINE_PACKAGE_NAME} package with the
     ...
     */
    public static Context getAlpinePackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, AlpineConstants.ALPINE_PACKAGE_NAME);
    }
     ...
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getAlpinePackageContextWithCode(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, AlpineConstants.ALPINE_PACKAGE_NAME, Context.CONTEXT_INCLUDE_CODE);
    }

    /**
     * Get the {@link Context} for {@link AlpineConstants#ALPINE_API_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getAlpineAPIPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, AlpineConstants.ALPINE_API_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link AlpineConstants#ALPINE_BOOT_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getAlpineBootPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, AlpineConstants.ALPINE_BOOT_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link AlpineConstants#ALPINE_FLOAT_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getAlpineFloatPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, AlpineConstants.ALPINE_FLOAT_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link AlpineConstants#ALPINE_STYLING_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getAlpineStylingPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, AlpineConstants.ALPINE_STYLING_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link AlpineConstants#ALPINE_TASKER_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getAlpineTaskerPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, AlpineConstants.ALPINE_TASKER_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link AlpineConstants#ALPINE_WIDGET_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getAlpineWidgetPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, AlpineConstants.ALPINE_WIDGET_PACKAGE_NAME);
    }
    ...
    public static Context getContextForPackageOrExitApp(@NonNull Context context, String packageName,
        ...
        return PackageUtils.getContextForPackageOrExitApp(context, packageName, exitAppOnError, AlpineConstants.ALPINE_GITHUB_REPO_URL);
    }

    /**
     * Check if Alpine app is installed and enabled. This can be used by external apps that don't
     * share `sharedUserId` with the Alpine app.
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.alpine`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.alpine/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.alpine" />
     *    </queries>
     * </manifest>
     * }
     *
     * @param context The context for operations.
     * @return Returns {@code errmsg} if {@link AlpineConstants#ALPINE_PACKAGE_NAME} is not installed
     * or disabled, otherwise {@code null}.
     */
    public static String isAlpineAppInstalled(@NonNull final Context context) {
        return PackageUtils.isAppInstalled(context, AlpineConstants.ALPINE_APP_NAME, AlpineConstants.ALPINE_PACKAGE_NAME);
    }

    /**
     * Check if Alpine:API app is installed and enabled. This can be used by external apps that don't
     * share `sharedUserId` with the Alpine:API app.
     *
     * @param context The context for operations.
     * @return Returns {@code errmsg} if {@link AlpineConstants#ALPINE_API_PACKAGE_NAME} is not installed
     * or disabled, otherwise {@code null}.
     */
    public static String isAlpineAPIAppInstalled(@NonNull final Context context) {
        return PackageUtils.isAppInstalled(context, AlpineConstants.ALPINE_API_APP_NAME, AlpineConstants.ALPINE_API_PACKAGE_NAME);
    }

    /**
     * Check if Alpine app is installed and accessible. This can only be used by apps that share
     * `sharedUserId` with the Alpine app.
     *
     ...
     * {@link AlpineConstants#ALPINE_PACKAGE_NAME} and then if
     * {@link AlpineConstants#ALPINE_PREFIX_DIR_PATH} exists and has
     ...
     * @return Returns {@code errmsg} if failed to get alpine package {@link Context} or
     * {@link AlpineConstants#ALPINE_PREFIX_DIR_PATH} is accessible, otherwise {@code null}.
     */
    public static String isAlpineAppAccessible(@NonNull final Context currentPackageContext) {
        String errmsg = isAlpineAppInstalled(currentPackageContext);
        if (errmsg == null) {
            Context alpinePackageContext = AlpineUtils.getAlpinePackageContext(currentPackageContext);
            // If failed to get Alpine app package context
            if (alpinePackageContext == null)
                errmsg = currentPackageContext.getString(R.string.error_alpine_app_package_context_not_accessible);

            if (errmsg == null) {
                // If AlpineConstants.ALPINE_PREFIX_DIR_PATH is not a directory or does not have required permissions
                Error error = AlpineFileUtils.isAlpinePrefixDirectoryAccessible(false, false);
                if (error != null)
                    errmsg = currentPackageContext.getString(R.string.error_alpine_prefix_dir_path_not_accessible,
                        PackageUtils.getAppNameForPackage(currentPackageContext));
            }
        }

        if (errmsg != null)
            return errmsg + " " + currentPackageContext.getString(R.string.msg_alpine_app_required_by_app,
                PackageUtils.getAppNameForPackage(currentPackageContext));
        else
            return null;
    }
    ...
    /**
     * Get a field value from the {@link ALPINE_APP#BUILD_CONFIG_CLASS_NAME} class of the Alpine app
     * APK installed on the device.
     * This can only be used by apps that share `sharedUserId` with the Alpine app.
     *
     * This is a wrapper for {@link #getAlpineAppAPKClassField(Context, String, String)}.
     *
     * @param currentPackageContext The context of current package.
     * @param fieldName The name of the field to get.
     * @return Returns the field value, otherwise {@code null} if an exception was raised or failed
     * to get alpine app package context.
     */
    public static Object getAlpineAppAPKBuildConfigClassField(@NonNull Context currentPackageContext,
                                                              @NonNull String fieldName) {
        return getAlpineAppAPKClassField(currentPackageContext, ALPINE_APP.BUILD_CONFIG_CLASS_NAME, fieldName);
    }

    /**
     * Get a field value from a class of the Alpine app APK installed on the device.
     * This can only be used by apps that share `sharedUserId` with the Alpine app.
     *
     * This is done by getting first getting alpine app package context and then getting in class
     * loader (instead of current app's) that contains alpine app class info, and then using that to
     * load the required class and then getting required field from it.
     *
     * Note that the value returned is from the APK file and not the current value loaded in Alpine
     ...
     * to get alpine app package context.
     */
    public static Object getAlpineAppAPKClassField(@NonNull Context currentPackageContext,
                                                   @NonNull String clazzName, @NonNull String fieldName) {
        try {
            Context alpinePackageContext = AlpineUtils.getAlpinePackageContextWithCode(currentPackageContext);
            if (alpinePackageContext == null)
                return null;

            Class<?> clazz = alpinePackageContext.getClassLoader().loadClass(clazzName);
    ...
    /** Returns {@code true} if {@link Uri} has `package:` scheme for {@link AlpineConstants#ALPINE_PACKAGE_NAME} or its sub plugin package. */
    public static boolean isUriDataForAlpineOrPluginPackage(@NonNull Uri data) {
        return data.toString().equals("package:" + AlpineConstants.ALPINE_PACKAGE_NAME) ||
            data.toString().startsWith("package:" + AlpineConstants.ALPINE_PACKAGE_NAME + ".");
    }

    /** Returns {@code true} if {@link Uri} has `package:` scheme for {@link AlpineConstants#ALPINE_PACKAGE_NAME} sub plugin package. */
    public static boolean isUriDataForAlpinePluginPackage(@NonNull Uri data) {
        return data.toString().startsWith("package:" + AlpineConstants.ALPINE_PACKAGE_NAME + ".");
    }
     ...
     */
    public static void sendAlpineOpenedBroadcast(@NonNull Context context) {
        Intent broadcast = new Intent(AlpineConstants.BROADCAST_ALPINE_OPENED);
        List<ResolveInfo> matches = context.getPackageManager().queryBroadcastReceivers(broadcast, 0);

        // send broadcast to registered Alpine receivers
    ...
    /**
     * Get a markdown {@link String} for the apps info of alpine app, its installed plugin apps or
     * external apps that called a Alpine API depending on {@link AppInfoMode} passed.
     *
    ...
    public static String getAppInfoMarkdownString(final Context currentPackageContext, final AppInfoMode appInfoMode, @Nullable String callingPackageName) {
        ...
        switch (appInfoMode) {
            ...
            case ALPINE_AND_PLUGIN_PACKAGE:
                return getAppInfoMarkdownString(currentPackageContext, true);

            case ALPINE_AND_PLUGIN_PACKAGES:
                appInfo.append(AlpineUtils.getAppInfoMarkdownString(currentPackageContext, false));

                String alpinePluginAppsInfo =  AlpineUtils.getAlpinePluginAppsInfoMarkdownString(currentPackageContext);
                if (alpinePluginAppsInfo != null)
                    appInfo.append("\n\n").append(alpinePluginAppsInfo);
                return appInfo.toString();

            case ALPINE_PLUGIN_PACKAGES:
                return AlpineUtils.getAlpinePluginAppsInfoMarkdownString(currentPackageContext);

            case ALPINE_AND_CALLING_PACKAGE:
                appInfo.append(AlpineUtils.getAppInfoMarkdownString(currentPackageContext, false));
                if (!DataUtils.isNullOrEmpty(callingPackageName)) {
                    String callingPackageAppInfo = null;
                    if (AlpineConstants.ALPINE_PLUGIN_APP_PACKAGE_NAMES_LIST.contains(callingPackageName)) {
                        Context alpinePluginAppContext = PackageUtils.getContextForPackage(currentPackageContext, callingPackageName);
                        if (alpinePluginAppContext != null)
                            appInfo.append(getAppInfoMarkdownString(alpinePluginAppContext, false));
                        else
    ...
    /**
     * Get a markdown {@link String} for the apps info of all/any alpine plugin apps installed.
     *
     * @param currentPackageContext The context of current package.
     * @return Returns the markdown {@link String}.
     */
    public static String getAlpinePluginAppsInfoMarkdownString(final Context currentPackageContext) {
        if (currentPackageContext == null) return "null";

        StringBuilder markdownString = new StringBuilder();

        List<String> alpinePluginAppPackageNamesList = AlpineConstants.ALPINE_PLUGIN_APP_PACKAGE_NAMES_LIST;

        if (alpinePluginAppPackageNamesList != null) {
            for (int i = 0; i < alpinePluginAppPackageNamesList.size(); i++) {
                String alpinePluginAppPackageName = alpinePluginAppPackageNamesList.get(i);
                Context alpinePluginAppContext = PackageUtils.getContextForPackage(currentPackageContext, alpinePluginAppPackageName);
                // If the package context for the plugin app is not null, then assume its installed and get its info
                if (alpinePluginAppContext != null) {
                    if (i != 0)
                        markdownString.append("\n\n");
                    markdownString.append(getAppInfoMarkdownString(alpinePluginAppContext, false));
                }
            }
        }
     ...
     * from the {@link AlpineConstants#ALPINE_PACKAGE_NAME} package context, then this function
     * must have been called by a different package like a plugin, so we return info for both packages
     * if {@code returnAlpinePackageInfoToo} is {@code true}.
     *
     * @param currentPackageContext The context of current package.
     * @param returnAlpinePackageInfoToo If set to {@code true}, then will return info of the
     * {@link AlpineConstants#ALPINE_PACKAGE_NAME} package as well if its different from current package.
     * @return Returns the markdown {@link String}.
     */
    public static String getAppInfoMarkdownString(final Context currentPackageContext, final boolean returnAlpinePackageInfoToo) {
        if (currentPackageContext == null) return "null";

        StringBuilder markdownString = new StringBuilder();

        Context alpinePackageContext = getAlpinePackageContext(currentPackageContext);

        String alpinePackageName = null;
        String alpineAppName = null;
        if (alpinePackageContext != null) {
            alpinePackageName = PackageUtils.getPackageNameForPackage(alpinePackageContext);
            alpineAppName = PackageUtils.getAppNameForPackage(alpinePackageContext);
        }
        ...
        boolean isAlpinePackage = (alpinePackageName != null && alpinePackageName.equals(currentPackageName));


        if (returnAlpinePackageInfoToo && !isAlpinePackage)
        ...
        if (returnAlpinePackageInfoToo && alpinePackageContext != null && !isAlpinePackage) {
            markdownString.append("\n\n## ").append(alpineAppName).append(" App Info\n");
            markdownString.append(getAppInfoMarkdownStringInner(alpinePackageContext));
            markdownString.append("\n##\n");
        }
    ...
    public static String getAppInfoMarkdownStringInner(@NonNull final Context context) {
        ...
        if (context.getPackageName().equals(AlpineConstants.ALPINE_PACKAGE_NAME)) {
            AndroidUtils.appendPropertyToMarkdown(markdownString, "ALPINE_APP_PACKAGE_MANAGER", AlpineBootstrap.ALPINE_APP_PACKAGE_MANAGER);
            AndroidUtils.appendPropertyToMarkdown(markdownString, "ALPINE_APP_PACKAGE_VARIANT", AlpineBootstrap.ALPINE_APP_PACKAGE_VARIANT);
        }

        Error error;
        error = AlpineFileUtils.isAlpineFilesDirectoryAccessible(context, true, true);
        if (error != null) {
            AndroidUtils.appendPropertyToMarkdown(markdownString, "ALPINE_FILES_DIR", AlpineConstants.ALPINE_FILES_DIR_PATH);
            AndroidUtils.appendPropertyToMarkdown(markdownString, "IS_ALPINE_FILES_DIR_ACCESSIBLE", "false - " + Error.getMinimalErrorString(error));
        }
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.alpine.shared.R.raw.apt_info_script);
        try {
        ...
        aptInfoScript = aptInfoScript.replaceAll(Pattern.quote("@ALPINE_PREFIX@"), AlpineConstants.ALPINE_PREFIX_DIR_PATH);

        ExecutionCommand executionCommand = new ExecutionCommand(-1,
            AlpineConstants.ALPINE_BIN_PREFIX_DIR_PATH + "/bash", null, aptInfoScript,
        ...
        markdownString.append("## ").append(AlpineConstants.ALPINE_APP_NAME).append(" APT Info\n\n");
    ...
    /**
     * Get a markdown {@link String} for info for alpine debugging.
     *
     * @param context The context for operations.
     * @return Returns the markdown {@link String}.
     */
    public static String getAlpineDebugMarkdownString(@NonNull final Context context) {
        String statInfo = AlpineFileUtils.getAlpineFilesStatMarkdownString(context);
    ...
    public static String getLogcatDumpMarkdownString(@NonNull final Context context) {
        ...
        // per object.
        // That many lines should be enough for debugging for recent issues anyways assuming alpine
    ...
    public static String getAPKRelease(String signingCertificateSHA256Digest) {
        ...
        switch (signingCertificateSHA256Digest.toUpperCase()) {
            ...
            case AlpineConstants.APK_RELEASE_GITHUB_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return AlpineConstants.APK_RELEASE_GITHUB;
            case AlpineConstants.APK_RELEASE_GOOGLE_PLAYSTORE_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return AlpineConstants.APK_RELEASE_GOOGLE_PLAYSTORE;
            case AlpineConstants.APK_RELEASE_ALPINE_DEVS_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return AlpineConstants.APK_RELEASE_ALPINE_DEVS;
            default:
                return "Unknown";
        }
    }
    ...
    /**
     * Get a process id of the main app process of the {@link AlpineConstants#ALPINE_PACKAGE_NAME}
     * package.
     *
     * @param context The context for operations.
     * @return Returns the process if found and running, otherwise {@code null}.
     */
    public static String getAlpineAppPID(final Context context) {
        return PackageUtils.getPackagePID(context, AlpineConstants.ALPINE_PACKAGE_NAME);
    }
