package com.alpine.shared.alpine.terminal;
...
public class AlpineTerminalSessionClientBase implements TerminalSessionClient {

    public AlpineTerminalSessionClientBase() {
    }
