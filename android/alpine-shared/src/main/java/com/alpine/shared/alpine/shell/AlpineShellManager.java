...
public class AlpineShellManager {

    private static AlpineShellManager shellManager;
    ...
    /**
     * The foreground AlpineSessions which this service manages.
     * Note that this list is observed by an activity, like AlpineActivity.mAlpineSessionListViewController,
     * so any changes must be made on the UI thread and followed by a call to
     * {@link ArrayAdapter#notifyDataSetChanged()}.
     */
    public final List<AlpineSession> mAlpineSessions = new ArrayList<>();

    /**
     * The background AlpineTasks which this service manages.
     */
    public final List<AppShell> mAlpineTasks = new ArrayList<>();
    ...
    public AlpineShellManager(@NonNull Context context) {
     ...
     * @return Returns the {@link AlpineShellManager}.
     */
    public static AlpineShellManager init(@NonNull Context context) {
        if (shellManager == null)
            shellManager = new AlpineShellManager(context);
     ...
     * @return Returns the {@link AlpineShellManager}.
     */
    public static AlpineShellManager getShellManager() {
        return shellManager;
    }
