package com.alpine.shared.activities;
 ...
 * {@code `<activity android:name="com.alpine.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.AlpineReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.alpine.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
    ...
    private void updateUI() {
        ...
        if (actionBar != null) {
            if (mReportInfo.reportTitle != null)
                ...
                actionBar.setTitle(AlpineConstants.ALPINE_APP_NAME + " App Report");
        }
