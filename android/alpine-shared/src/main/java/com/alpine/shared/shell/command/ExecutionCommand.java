package com.alpine.shared.shell.command;
...
public class ExecutionCommand {
    ...
    Only the {@link #errCode} being non-zero means that execution command failed from the Alpine app
    perspective.
    */
     ...
     * commands. By default, @link com.alpine.shared.shell.StreamGobbler} only logs stdout and
    ...
    /** Defines the markdown text for the help of the Alpine plugin API that was used to start the
     ...
     * like with an intent or from within Alpine app itself. */
