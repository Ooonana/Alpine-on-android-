package com.alpine.shared.file;
...
import com.alpine.shared.errors.FunctionErrno;
...
public class FileUtils {
    ...
    public static Error deleteFile(String label, final String filePath, final boolean ignoreNonExistentFile, final boolean ignoreWrongFileType, int allowedFileTypeFlags) {
        ...
        try {
            ...
            if (fileType == FileType.DIRECTORY) {
                // deleteDirectory() enumerates the directory before deletion and does not require
                // Guava's JRE-only MoreFiles API, which is absent from Guava's Android artifact.
